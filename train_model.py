...
print("=" * 60)
print("  SHADOWGUARD  |  Model Training Module")
print("=" * 60)

# ─── Load Data ───────────────────────────────────────────────────────────────
print("\n[1/6] Loading balanced dataset...")
...
print("\n[2/6] Running 5-fold cross-validation on all models...")
...
print(f"\n[3/6] Winner: {best_name} (F1 = {cv_results[best_name]['f1']:.4f})")

# ─── Hyperparameter Tuning (GridSearchCV) ─────────────────────────────────────
print(f"\n[4/6] Tuning hyperparameters for {best_name}...")
